...
const KnowledgeCard: React.FC<KnowledgeCardProps> = ({ iconPath, text1, text2,
    ...
    return (
      <div className="knowledge-card flex flex-col items-center bg-white w-80 h-56 py-12 px-12 mx-6 my-4 transform transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-lg">
